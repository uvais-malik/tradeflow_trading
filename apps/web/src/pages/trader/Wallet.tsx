      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <header className="flex items-center justify-between bg-slate-800/40 backdrop-blur-xl px-6 py-4 rounded-xl border border-slate-700/50">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 tracking-tight">Funding & Wallet</h1>
              <p className="text-sm text-slate-400 font-medium mt-1">Manage your fiat balances securely</p>
            </div>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-800/60 backdrop-blur-md rounded-xl border border-slate-700/50 p-8 flex items-center justify-between shadow-xl">
            <div>
