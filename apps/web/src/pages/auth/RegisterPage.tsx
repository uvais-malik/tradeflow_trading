  ...
  return (
    <div className="flex h-screen items-center justify-center bg-[#0B1220] selection:bg-indigo-500/30 p-4">
      <div className="w-full max-w-md p-8 glass-card">
        <h2 className="text-2xl font-extrabold mb-6 text-center text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 tracking-tight">TradeFlow Register</h2>
        ...
        <p className="mt-6 text-center text-sm text-slate-400">
          Already have an account? <Link to="/login" className="text-indigo-400 font-bold hover:text-indigo-300 transition-colors">Login</Link>
        </p>
      </div>
    </div>
  );
